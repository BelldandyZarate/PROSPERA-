      ...
      .then((data) => {
        if (data.success && data.data) {
          ...
          const formattedData = {
            ...
            observaciones: productoData.observaciones || "" // Nuevo campo agregado
          };
          
          setProducto(formattedData);
        } else {
          alert("Producto no encontrado");
          navigate("/TablaproductosRe");
        }
      })
      .catch((error) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const datosEnviar = {
        ...
        observaciones: producto.observaciones.trim() // Nuevo campo agregado
      };
        ...
        <div className="card shadow" style={{ maxWidth: "1000px", margin: "0 auto" }}>
          <div className="card-header bg-primary text-white d-flex justify-content-between align-items-center">
            ...
            <button 
              ...
              onClick={() => navigate('/TablaproductosRe')}
            >
          ...
          <div className="card-body">
            <form onSubmit={handleSubmit}>
              ...
              {/* Secciones agregadas: Nombre del Producto, Fecha y Observaciones */}
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  placeholder={producto.tipo_producto === PRODUCT_TYPES.VEGETABLES_FRUITS 
              ...
              <div className="mb-4">
                ...
                <small className="text-muted">Seleccione la fecha en que recibió el producto</small>
              </div>
...
export default EditarProductoRe;